...
<div class="list-group">
  <a href="https://disk.yandex.ru/i/BJyQ2rYcXrA99g" class="bg-warning text-dark bg-opacity-50 list-group-item list-group-item-action" aria-current="true" target="_blank"><i class="bi bi-film"></i> Протокол активации апоптоза адипозных клеток</a>
</div>
