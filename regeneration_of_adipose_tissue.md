...
<div class="list-group">
  <a href="https://disk.yandex.ru/i/qOD6DqMJ-b2ifw" class="bg-warning text-dark bg-opacity-50 list-group-item list-group-item-action" aria-current="true" target="_blank"><i class="bi bi-film"></i> Протокол по регенерации адипозной ткани</a>
    <a href="https://disk.yandex.ru/i/sq0NpcocRlx8Pw" class="bg-warning text-dark bg-opacity-50 list-group-item list-group-item-action" aria-current="true" target="_blank"><i class="bi bi-film"></i> Работа с локальными жировыми отложениями</a>
      <a href="https://disk.yandex.ru/i/0wMIZuVeJoVALg" class="bg-warning text-dark bg-opacity-50 list-group-item list-group-item-action" aria-current="true" target="_blank"><i class="bi bi-film"></i> Видео проведения процедуры</a>
</div>
